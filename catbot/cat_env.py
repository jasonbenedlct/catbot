...
class TrainerCat(Cat):
    ...
    def move(self) -> None:
        ...
        # Inverse directions: 0 (Up) -> 1 (Down), 1 (Down) -> 0 (Up)
        #                     2 (Left) -> 3 (Right), 3 (Right) -> 2 (Left)
        mirror_moves = {0: (1, 0), 1: (-1, 0), 2: (0, 1), 3: (0, -1)}
        dr, dc = mirror_moves.get(self.last_player_action, (0, 0))
